...
const _chalk = /*#__PURE__*/ _interop_require_default(__webpack_require__(6347));
...
const _requestcookies = __webpack_require__(4980);
const _headers = __webpack_require__(4235);
const _cookies = __webpack_require__(5185);
const _requestasyncstorage = __webpack_require__(7078);
const _actionasyncstorage = __webpack_require__(2024);
const _staticgenerationbailout = __webpack_require__(226);
const _draftmode = __webpack_require__(3377);
function headers() {
...
let chalk;
if (false) {} else {
    chalk = __webpack_require__(4328);
}
...
const _headers = __webpack_require__(4235);
const _constants = __webpack_require__(1457);
function getCookieParser(headers) {
    return function parseCookie() {
        ...
        const { parse: parseCookieFn } = __webpack_require__(154);
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(154);
...
const _apiutils = __webpack_require__(2843);
...
const _requestcookies = __webpack_require__(4980);
const _cookies = __webpack_require__(5185);
const _draftmodeprovider = __webpack_require__(6870);
...
const _http = __webpack_require__(3321);
const _responsehandlers = __webpack_require__(3138);
...
const _cookies = __webpack_require__(7463);
const _nexturl = __webpack_require__(5416);
const _cleanurl = __webpack_require__(1267);
...
const _notfound = __webpack_require__(9305);
const _redirect = __webpack_require__(1942);
const _responsehandlers = __webpack_require__(3138);
...
const _routemodule = __webpack_require__(9398);
const _requestasyncstoragewrapper = __webpack_require__(4564);
const _staticgenerationasyncstoragewrapper = __webpack_require__(7433);
const _responsehandlers = __webpack_require__(3138);
const _http = __webpack_require__(3321);
const _patchfetch = __webpack_require__(3731);
const _tracer = __webpack_require__(38);
const _constants = __webpack_require__(6258);
const _getpathnamefromabsolutepath = __webpack_require__(2666);
const _proxyrequest = __webpack_require__(5155);
const _resolvehandlererror = __webpack_require__(8094);
const _log = /*#__PURE__*/ _interop_require_wildcard(__webpack_require__(5924));
const _autoimplementmethods = __webpack_require__(6835);
const _getnonstaticmethods = __webpack_require__(6097);
const _requestcookies = __webpack_require__(4980);
const _routekind = __webpack_require__(6221);
const _parsedurlquerytoparams = __webpack_require__(3642);
...
const headerHooks = __webpack_require__(7791);
...
const _detectdomainlocale = __webpack_require__(8136);
const _formatnextpathnameinfo = __webpack_require__(319);
const _gethostname = __webpack_require__(7013);
const _getnextpathnameinfo = __webpack_require__(3329);
...
const _formatnextpathnameinfo = __webpack_require__(5291);
const _gethostname = __webpack_require__(8776);
const _getnextpathnameinfo = __webpack_require__(2184);
const REGEX_LOCALHOST_HOSTNAME = /(?!^https?:\/\/)(127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}|\[::1\]|localhost)/;
function parseURL(url, base) {
    return new URL(String(url).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"), base && String(base).replace(REGEX_LOCALHOST_HOSTNAME, "localhost"));
}
...
const _reflect = __webpack_require__(2946);
...
const _cookies = __webpack_require__(1917); //# sourceMappingURL=cookies.js.map
...
const _cookies = __webpack_require__(7463); //# sourceMappingURL=cookies.js.map
...
const _nexturl = __webpack_require__(860);
const _utils = __webpack_require__(2940);
const _error = __webpack_require__(5826);
const _cookies = __webpack_require__(4629);
...
const _uaparserjs = /*#__PURE__*/ _interop_require_default(__webpack_require__(2584));
function _interop_require_default(obj) {
    return obj && obj.__esModule ? obj : {
        default: obj
    };
...
const _addpathprefix = __webpack_require__(7988);
const _pathhasprefix = __webpack_require__(1203);
...
const _addpathprefix = __webpack_require__(126);
const _pathhasprefix = __webpack_require__(4519);
function addLocale(path, locale, defaultLocale, ignorePrefix) {
    // If no locale was given or the locale is the default locale, we don't need
    // to prefix the path.
    if (!locale || locale === defaultLocale) return path;
...
const _parsepath = __webpack_require__(8737);
...
const _parsepath = __webpack_require__(5482);
function addPathPrefix(path, prefix) {
    if (!path.startsWith("/") || !prefix) {
        return path;
    }
...
const _removetrailingslash = __webpack_require__(9563);
const _addpathprefix = __webpack_require__(7988);
const _addpathsuffix = __webpack_require__(8834);
const _addlocale = __webpack_require__(9080);
...
const _addpathprefix = __webpack_require__(126);
const _addpathsuffix = __webpack_require__(9994);
const _addlocale = __webpack_require__(2159);
function formatNextPathnameInfo(info) {
    let pathname = (0, _addlocale.addLocale)(info.pathname, info.locale, info.buildId ? undefined : info.defaultLocale, info.ignorePrefix);
    if (info.buildId || !info.trailingSlash) {
        pathname = (0, _removetrailingslash.removeTrailingSlash)(pathname);
...
const _normalizelocalepath = __webpack_require__(4124);
const _removepathprefix = __webpack_require__(8378);
const _pathhasprefix = __webpack_require__(1203);
...
const _removepathprefix = __webpack_require__(4242);
const _pathhasprefix = __webpack_require__(4519);
function getNextPathnameInfo(pathname, options) {
    var _options_nextConfig;
    const { basePath, i18n, trailingSlash } = (_options_nextConfig = options.nextConfig) != null ? _options_nextConfig : {};
...
const serverExports = {
    NextRequest: (__webpack_require__(9646).NextRequest),
    NextResponse: (__webpack_require__(9739)/* .NextResponse */ .x),
    ImageResponse: (__webpack_require__(5704)/* .ImageResponse */ .E),
    userAgentFromString: (__webpack_require__(8541).userAgentFromString),
    userAgent: (__webpack_require__(8541).userAgent)
};
